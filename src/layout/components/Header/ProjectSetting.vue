...
export default defineComponent({
  ...
  setup(props) {
    ...
    const state = reactive({
      ...
      placement: 'right',
      alertText:
          '该功能主要实时预览各种布局效果，更多完整配置在 projectSetting.ts 中设置，并持久化存储。',
  ...
  <n-drawer v-model:show="isDrawer" :width="width" :placement="placement">
    <n-drawer-content :title="title" :native-scrollbar="false">
      <div class="drawer">
        ...
        <div class="justify-center drawer-setting-item">
          <DarkModeToggle />
        </div>
        ...
        <div class="drawer-setting-item align-items-top">
          <div class="drawer-setting-item-style align-items-top">
            ...
            <n-badge v-show="settingStore.navMode === 'vertical'" dot :color="dot" />
          </div>
          ...
          <div class="drawer-setting-item-style">
            ...
            <n-badge v-show="settingStore.navMode === 'horizontal'" dot :color="dot" />
          </div>
          ...
          <div class="drawer-setting-item-style">
            ...
            <n-badge v-show="settingStore.navMode === 'horizontal-mix'" dot :color="dot" />
          </div>
        </div>
        ...
        <div class="drawer-setting-item align-items-top">
          <div class="drawer-setting-item-style align-items-top">
            ...
            <n-badge v-if="settingStore.navTheme === 'dark'" dot :color="dot" />
          </div>
          ...
          <div class="drawer-setting-item-style">
            ...
            <n-badge v-if="settingStore.navTheme === 'light'" dot :color="dot" />
          </div>
          ...
          <div class="drawer-setting-item-style">
            ...
            <n-badge v-if="settingStore.navTheme === 'header-dark'" dot :color="dot" />
          </div>
        </div>
        <n-divider title-placement="center">
          界面功能
